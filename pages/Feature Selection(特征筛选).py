...
new_continous_feature = []
for res in results:
    if res in st.session_state.continuous_features:
        new_continous_feature.append(res)

st.session_state.continuous_features = new_continous_feature
